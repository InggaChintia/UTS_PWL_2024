...
ack">
    ...
    <style>
        body {
            background-image: url('{{ url('dist/img/toko.jpeg') }}');
        ...
        .card img {
            display: block;
            margin: 0 auto; /* Aligns horizontally to center */
        }
        ...
        .brand-image {
            ...
            height: 200px;
            width: 200px;
            object-fit: cover; /* Ensures the logo fits properly */
        }
    </style>
</head>
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="card card-outline card-primary">
            <img src="{{ url('/dist/img/logo_toko.jpeg') }}" alt="cintisari-bakery"
                class="brand-image img-circle align-center" style="opacity: .8;height:200px;width:200px">
            <div class="card-body">
